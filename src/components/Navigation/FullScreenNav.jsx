            ...
            <div className=" moveLink flex absolute top-0 transition-all duration-300 bg-[#D3FD50]">
              <div className="flex items-center moveX">
                ...
                <img
                  ...
                  src="src/assets/photos/WS---K72.ca---MenuThumbnail.jpg"
                  alt=""
                />
                <h2 className="whitespace-nowrap px-6 font-[font2] lg:text-[8vw] text-[15vw] leading-[0.8] lg:pt-5 pt-2 text-center text-black uppercase">
                  Pour tout voir
                ...
                <img
                  className="w-64 shrink-0 object-cover rounded-full h-24"
                  src="src/assets/photos/PJC_SiteK72_Thumbnail_640x290.jpg"
                  alt=""
                />
              </div>
              <div className="flex items-center moveX">
          ...
          >
            ...
            <div className=" moveLink flex absolute top-0 transition-all duration-300 bg-[#D3FD50]">
              <div className="flex items-center moveX">
                ...
                <img
                  className="w-64 shrink-0 object-cover rounded-full h-24"
                  src="src/assets/photos/Michele_640x290.jpg"
                  alt=""
                />
                <h2 className="whitespace-nowrap px-6 font-[font2] lg:text-[8vw] text-[15vw] leading-[0.8] lg:pt-5 pt-2 text-center text-black uppercase">
                  Pour tout savoir
                ...
                <img
                  className="w-64 shrink-0 object-cover rounded-full h-24"
                  src="src/assets/photos/SophieA_640X290.jpg"
                  alt=""
                />
              </div>
              <div className="flex items-center moveX">
          ...
          >
            ...
            <div className=" moveLink flex absolute top-0 transition-all duration-300 bg-[#D3FD50]">
              <div className="flex items-center moveX">
                ...
                <img
                  className="w-64 shrink-0 object-cover rounded-full h-24"
                  src="src/assets/photos/ier.com-16107673482102220.gif"
                  alt=""
                />
                <h2 className="whitespace-nowrap px-6 font-[font2] lg:text-[8vw] text-[15vw] leading-[0.8] lg:pt-5 pt-2 text-center text-black uppercase">
                  Lire les articles
                ...
                <img
                  className="w-64 shrink-0 object-cover rounded-full h-24"
                  src="src/assets/photos/50ff59cc0550df5b36543807a58db98c52e01a22274a317eafbfa5266941579b.png"
                  alt=""
                />
              </div>
              <div className="flex items-center moveX">
